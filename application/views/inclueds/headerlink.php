...
<head>
    ...
    <title> Purple Initiative Private Limited </title>
    <!-- favicons Icons -->
    ...
    <link rel="stylesheet" href="<?= base_url() ?>assets/vendors/oxpins-icons/style.css">
    ...
    <!-- template styles -->
    <link rel="stylesheet" href="<?= base_url() ?>assets/css/oxpins.css" />
    <link rel="stylesheet" href="<?= base_url() ?>assets/css/oxpins-responsive.css" />
</head>